...
int main(int argc, char* argv[])
{
    ...
    if (coordinador.getEstado() == 1 || coordinador.getEstado() == 2 || coordinador.getEstado() == 4) {
        ETSIDI::stopMusica();
        ETSIDI::playMusica("Texturas/Sonidos/musicafondo.mp3", true);
    }
    if (coordinador.getEstado() == 3) {
        ETSIDI::stopMusica();
        ETSIDI::play("Texturas/Sonidos/gameover.mp3");
    }
    if (coordinador.getEstado() == 5) {
        ETSIDI::stopMusica();
        ETSIDI::play("Texturas/Sonidos/victoria_pasaralboss.mp3");
    }
    if (coordinador.getEstado() == 7) {
        ETSIDI::stopMusica();
